...
export const HeroBackground: React.FC = () => {
  ...
  return (
    <div ref={containerRef} className="absolute inset-0 overflow-hidden pointer-events-none z-0">
      ...
      <motion.div style={{ y: yClouds }} className="absolute inset-0 opacity-20 transform-gpu">
        <motion.div 
      ...
      <motion.div style={{ y: yRays }} className="absolute inset-0 opacity-20 mix-blend-overlay transform-gpu">
        <div className="absolute top-[-10%] left-[15%] w-[30%] h-[150%] bg-gradient-to-b from-white via-white/40 to-transparent rotate-[30deg]  transform translate-z-0" />
        <div className="absolute top-[-10%] right-[20%] w-[25%] h-[130%] bg-gradient-to-b from-golden-light via-golden-light/30 to-transparent rotate-[-20deg]  transform translate-z-0" />
      </motion.div>
      ...
      <div className="absolute inset-0 transform-gpu">
        {[...Array(3)].map((_, i) => (
          <motion.div
            key={`rose-bokeh-${i}`}
            className="absolute rounded-full bg-rose-light opacity-[0.08] "
            style={{
      ...
      <motion.div style={{ y: yParticles }} className="absolute inset-0 transform-gpu">
        {[...Array(12)].map((_, i) => {
