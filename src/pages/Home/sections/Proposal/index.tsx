...
const ClimaxProposal: React.FC<{ onExplode: () => void }> = ({ onExplode }) => {
  ...
  return (
    <div ref={containerRef} className="min-h-[100dvh] flex-1 w-full flex items-center justify-center relative z-20">
...
export const ProposalSection: React.FC = () => {
  ...
  return (
    <SectionWrapper id="proposal" background="none" fullHeight={false} className="p-0 py-0 md:py-0 relative overflow-hidden bg-[#0a0f1d]">
      ...
      >
        ...
        <div className="absolute top-0 left-0 w-full min-h-[500dvh] bg-gradient-to-b from-[#0a0f1d] via-[#12163b] to-black opacity-100 z-0 pointer-events-none" />
        ...
        <div className="sticky top-0 w-full h-[100dvh] overflow-hidden pointer-events-none z-0">
          <motion.div 
            ...
            className="absolute top-[-10%] right-[-10%] w-[80%] h-[80dvh] bg-[#36428c]/30  rounded-full pointer-events-none"
          />
          <motion.div 
            animate={{ opacity: hasExploded ? 0 : [0.1, 0.3, 0.1] }}
            transition={{ duration: 15, repeat: Infinity, ease: "easeInOut", delay: 2 }}
            className="absolute bottom-[-10%] left-[-10%] w-[90%] h-[70dvh] bg-[#7a5eb5]/20  rounded-full pointer-events-none"
          />
        </div>
