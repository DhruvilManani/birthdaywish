  ...
  return (
    <SectionWrapper id="chapter-three" background="none" fullHeight={false} className="h-full p-0 py-0 md:py-0 relative overflow-hidden bg-[#faf7f2]">
      ...
      <div className="relative flex flex-col flex-1 w-full h-full overflow-y-auto overflow-x-hidden allow-scroll scroll-smooth">
        ...
        <div className="absolute top-0 left-0 w-full min-h-[400dvh] bg-gradient-to-b from-transparent via-[#ffdcb0]/30 to-[#3b2f63]/40 opacity-80 z-0 pointer-events-none" />
        
        {/* Paper texture */}
        <div className="absolute top-0 left-0 w-full min-h-[400dvh] pointer-events-none opacity-[0.25] mix-blend-multiply z-0" style={{ backgroundImage: 'url("data:image/svg+xml,%3Csvg viewBox=%220 0 200 200%22 xmlns=%22http://www.w3.org/2000/svg%22%3E%3Cfilter id=%22noiseFilter%22%3E%3CfeTurbulence type=%22fractalNoise%22 baseFrequency=%220.8%22 numOctaves=%223%22 stitchTiles=%22stitch%22/%3E%3C/filter%3E%3Crect width=%22100%25%22 height=%22100%25%22 filter=%22url(%23noiseFilter)%22/%3E%3C/svg%3E")' }} />
        ...
        <div className="sticky top-0 w-full h-[100dvh] overflow-hidden pointer-events-none z-0">
          <motion.div 
            ...
            className="absolute -top-[20%] right-[-10%] w-[80%] h-[80dvh] bg-[#ffb7a1]/20  rounded-full pointer-events-none"
          />
          <motion.div 
            animate={{ opacity: [0.2, 0.5, 0.2], scale: [1, 1.2, 1] }}
            transition={{ duration: 18, repeat: Infinity, ease: "easeInOut", delay: 2 }}
            className="absolute bottom-[-10%] left-[-10%] w-[90%] h-[70dvh] bg-[#a890fe]/15  rounded-full pointer-events-none"
          />
        </div>
