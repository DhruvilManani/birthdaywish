        ...
        <AnimatePresence>
          {showPrev && (
            <motion.button
              ...
              onClick={onPrev}
              className="group relative flex items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-full bg-[#fdfbf7]/90 backdrop-blur-sm border border-[#e6b3a6]/40 shadow-[0_8px_32px_rgba(230,179,166,0.15)] hover:bg-white hover:scale-105 active:scale-95 transition-all duration-300"
          ...
          {showNext && (
            ...
            >
              <motion.button
                ...
                onClick={onNext}
                className="group relative flex items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-full bg-[#fdfbf7]/90 backdrop-blur-sm border border-[#e6b3a6]/50 shadow-[0_8px_32px_rgba(230,179,166,0.25)] hover:bg-white hover:scale-105 active:scale-95 transition-all duration-300"
