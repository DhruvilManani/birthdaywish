...
export const LuxuryButton: React.FC<LuxuryButtonProps> = ({
  ...
  const variants = {
    ...
    secondary: cn(
      'bg-cream-dark/85 text-rose border-soft-pink/30 hover:bg-soft-pink-light/80 backdrop-blur-md shadow-sm',
      glow && 'hover:shadow-[0_8px_20px_rgba(230,230,250,0.4)]'
    ),
    outline: cn(
      'bg-transparent border-white/40 text-neutral-800 backdrop-blur-md hover:bg-white/20 hover:border-white/60 shadow-sm'
    ),
    gold: cn(
