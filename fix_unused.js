...
if (fs.existsSync(memViewer)) {
  ...
  content = content.replace(/const \[isZoomed, setIsZoomed\] = useState<boolean>\(false\);/, "");
  content = content.replace(/const \[isZoomed, setIsZoomed\] = useState\(false\);/, "");
  // just replace isZoomed entirely
